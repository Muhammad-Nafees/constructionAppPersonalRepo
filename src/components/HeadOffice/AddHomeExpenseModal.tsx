// components/HeadOffice/AddHomeExpenseModal.tsx
...
const AddHomeExpenseModal = ({ categories, onClose, onSave }: Props) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-xl max-w-md w-full p-6">
        <h3 className="text-xl font-bold mb-4">Add Home Expense</h3>
...
export default AddHomeExpenseModal;