...
const AddCelebrityForm: React.FC<AddCelebrityFormProps> = ({
    ...
    console.log("🚀 ~ bulkFiles:", bulkFiles)
    ...
    const handleBulkUpload = useCallback(async (values: CelebritiesValuesSchema) => {
        ...
        try {
            ...
            console.log("🚀 ~ handleBulkUpload ~ bulkFiles:", bulkFiles)
                                    ...
                                    <div className="w-full sm:w-1/2">
                                        {!editingData && (
                                            <>
                                                ...
                                                <div {...singleDropzone.getRootProps()} className="w-full h-48 sm:h-70 px-4 py-3 border border-orange-400 outline-none text-sm sm:text-base cursor-pointer flex items-center justify-center">                                                    <input {...singleDropzone.getInputProps()} />
                                        ...
                                        {editingData?.celebrityImage && typeof editingData.celebrityImage === 'object' && 'url' in editingData.celebrityImage && (
                                            <div className="mt-4">
                                                ...
                                                <div className="bg-white p-3 rounded border border-gray-300 shadow-sm">
                                                    <div className="flex items-center justify-between">
                                                        <div className="flex items-center gap-3">
                                                            <img
                                                                src={editingData.celebrityImage.url}
                                                                alt="Current celebrity"
